        ...
        if Species.query.count() == 0:
            ...
            all_species = {
                ...
                'Ariocarpus fissuratus': {
                    ...
                    'substrate': 'Mineralisch mit etwas Humus',
                    'temperature': '20-28°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Der "Greisenhaupt-Kaktus" mit seiner weißen Behaarung. Langsam wachsend.',
                    'temperature_min': 15,
                    'temperature_max': 30,
                    'watering_summer': 'Regelmäßig, aber mäßig',
                    'watering_winter': 'Sehr sparsam',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Weiße Haare vor Verschmutzung schützen'
                },
                'Parodia leninghausii': {
                    'substrate': 'Mineralisch',
                    'temperature': '20-28°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Goldener Säulenkaktus, relativ pflegeleicht.',
                    'temperature_min': 10,
                    'temperature_max': 30,
                    'watering_summer': 'Regelmäßig',
                    'watering_winter': 'Fast trocken',
                    'light_requirements': 'Hell bis vollsonnig',
                    'special_care': 'Bildet mit der Zeit Gruppen'
                },
                'Mammillaria vetula ssp gracilis albata': {
                    'substrate': 'Mineralisch, durchlässig',
                    'temperature': '18-25°C',
                    'germination_time': '1-2 Wochen',
                    'care_notes': 'Kleine, gruppenbildende Art. Sehr pflegeleicht.',
                    'temperature_min': 10,
                    'temperature_max': 28,
                    'watering_summer': 'Mäßig',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Hell, leichte Mittagsschattierung',
                    'special_care': 'Ableger fallen leicht ab und bewurzeln schnell'
                },
                'Euphorbia ritchiei': {
                    'substrate': 'Mineralisch, sandig',
                    'temperature': '20-30°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'VORSICHT: Giftiger Milchsaft! Handschuhe tragen.',
                    'temperature_min': 15,
                    'temperature_max': 35,
                    'watering_summer': 'Mäßig, gut abtrocknen lassen',
                    'watering_winter': 'Sehr sparsam',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Milchsaft ist giftig und hautreizend!'
                },
                'Euphorbia enopla': {
                    'substrate': 'Mineralisch, sandig',
                    'temperature': '20-30°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Säulenförmige Euphorbie mit roten Dornen. VORSICHT: Giftiger Milchsaft!',
                    'temperature_min': 12,
                    'temperature_max': 35,
                    'watering_summer': 'Mäßig',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Sehr dekorativ, aber giftig!'
                },
                'Mammillaria sp.': {
                    'substrate': 'Mineralisch',
                    'temperature': '20-28°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Unbestimmte Mammillaria-Art. Standard-Pflege für Mammillarien.',
                    'temperature_min': 10,
                    'temperature_max': 30,
                    'watering_summer': 'Regelmäßig, aber mäßig',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Hell bis vollsonnig',
                    'special_care': 'Blüht meist im Kranz um den Scheitel'
                },
                'Adromischus sp.': {
                    'substrate': 'Mineralisch mit wenig organischem Anteil',
                    'temperature': '18-25°C',
                    'germination_time': '2-3 Wochen',
                    'care_notes': 'Kleine Sukkulente mit dicken, oft gefleckten Blättern.',
                    'temperature_min': 10,
                    'temperature_max': 28,
                    'watering_summer': 'Vorsichtig, Blätter fallen leicht ab',
                    'watering_winter': 'Sehr sparsam',
                    'light_requirements': 'Hell, keine pralle Sonne',
                    'special_care': 'Blätter bewurzeln leicht'
                },
                'Echinocereus sp.': {
                    'substrate': 'Mineralisch',
                    'temperature': '20-30°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Igelsäulenkaktus mit prächtigen Blüten.',
                    'temperature_min': 5,
                    'temperature_max': 35,
                    'watering_summer': 'Regelmäßig',
                    'watering_winter': 'Trocken und kühl',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Winterkälte fördert Blütenbildung'
                },
                'Pachycereus sp.': {
                    'substrate': 'Mineralisch, durchlässig',
                    'temperature': '22-35°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Großer Säulenkaktus, sehr langsam wachsend.',
                    'temperature_min': 15,
                    'temperature_max': 40,
                    'watering_summer': 'Bei Hitze durchdringend',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Volle Wüstensonne',
                    'special_care': 'Kann riesig werden (in der Natur)'
                },
                'Rhipsalis pilocarpa': {
                    'substrate': 'Humusreich, durchlässig',
                    'temperature': '18-25°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Epiphytischer Kaktus, benötigt höhere Luftfeuchtigkeit.',
                    'temperature_min': 12,
                    'temperature_max': 28,
                    'watering_summer': 'Regelmäßig feucht',
                    'watering_winter': 'Mäßig feucht',
                    'light_requirements': 'Hell, aber keine direkte Sonne',
                    'special_care': 'Hängender Wuchs, ideal für Ampeln'
                },
                'Aloe humilis': {
                    'substrate': 'Mineralisch mit etwas organischem Anteil',
                    'temperature': '18-28°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Kleine, gruppenbildende Aloe. Pflegeleicht.',
                    'temperature_min': 5,
                    'temperature_max': 35,
                    'watering_summer': 'Mäßig, gut abtrocknen lassen',
                    'watering_winter': 'Sparsam',
                    'light_requirements': 'Hell bis vollsonnig',
                    'special_care': 'Bildet viele Ableger'
                },
                'Polaskia chichipe': {
                    'substrate': 'Mineralisch',
                    'temperature': '20-30°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Mexikanischer Säulenkaktus, verzweigt sich im Alter.',
                    'temperature_min': 10,
                    'temperature_max': 35,
                    'watering_summer': 'Regelmäßig',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Essbare Früchte in der Heimat'
                },
                'Begonia rex': {
                    'substrate': 'Humusreich, locker, leicht sauer',
                    'temperature': '18-24°C',
                    'germination_time': '2-3 Wochen',
                    'care_notes': 'KEINE Sukkulente! Blattbegonie mit dekorativen Blättern.',
                    'temperature_min': 15,
                    'temperature_max': 26,
                    'watering_summer': 'Gleichmäßig feucht',
                    'watering_winter': 'Mäßig feucht',
                    'light_requirements': 'Hell, aber keine direkte Sonne',
                    'special_care': 'Hohe Luftfeuchtigkeit wichtig'
                },
                'Melocactus matanzanus': {
                    'substrate': 'Rein mineralisch, kalkhaltig',
                    'temperature': '22-30°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Bildet im Alter ein Cephalium (Blütenkopf). Sehr wärmebedürftig.',
                    'temperature_min': 18,
                    'temperature_max': 35,
                    'watering_summer': 'Vorsichtig, fäulnisempfindlich',
                    'watering_winter': 'Warm und trocken',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Niemals unter 15°C!'
                },
                'Echinopsis subdenudata': {
                    'substrate': 'Mineralisch mit etwas Humus',
                    'temperature': '20-28°C',
                    'germination_time': '1-2 Wochen',
                    'care_notes': 'Seeigelkaktus, blüht nachts mit großen weißen Blüten.',
                    'temperature_min': 5,
                    'temperature_max': 35,
                    'watering_summer': 'Regelmäßig',
                    'watering_winter': 'Trocken und kühl',
                    'light_requirements': 'Hell bis vollsonnig',
                    'special_care': 'Duftende Nachtblüten'
                },
                'Euphorbia obesa': {
                    'substrate': 'Mineralisch, sehr durchlässig',
                    'temperature': '20-28°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Baseball-Pflanze. Kugelförmig, VORSICHT: Giftiger Milchsaft!',
                    'temperature_min': 10,
                    'temperature_max': 35,
                    'watering_summer': 'Sparsam',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Zweihäusig (männlich/weiblich)'
                },
                'Obregonia denegrii': {
                    'substrate': 'Rein mineralisch, kalkhaltig',
                    'temperature': '20-28°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Artischockenkaktus. Sehr langsam wachsend, selten.',
                    'temperature_min': 10,
                    'temperature_max': 32,
                    'watering_summer': 'Sehr vorsichtig',
                    'watering_winter': 'Absolut trocken',
                    'light_requirements': 'Hell, leichte Schattierung',
                    'special_care': 'Extrem langsames Wachstum'
                },
                'Pseudolithos sp.': {
                    'substrate': 'Rein mineralisch, sehr durchlässig',
                    'temperature': '25-35°C',
                    'germination_time': '3-6 Wochen',
                    'care_notes': 'Lebender Stein aus Somalia/Arabien. Sehr schwierig!',
                    'temperature_min': 20,
                    'temperature_max': 40,
                    'watering_summer': 'Minimal, nur nebeln',
                    'watering_winter': 'Knochentrocken',
                    'light_requirements': 'Sehr hell',
                    'special_care': 'Extreme Wärme nötig, oft gepfropft'
                },
                'Aztekium ritteri': {
                    'substrate': 'Rein mineralisch, Gips/Kalk',
                    'temperature': '20-28°C',
                    'germination_time': '3-8 Wochen',
                    'care_notes': 'Extrem langsam wachsend. Mexikanische Rarität.',
                    'temperature_min': 10,
                    'temperature_max': 32,
                    'watering_summer': 'Minimal',
                    'watering_winter': 'Absolut trocken',
                    'light_requirements': 'Hell',
                    'special_care': 'Wächst auf Gipsfelsen, oft gepfropft'
                },
                'Aztekium hintonii': {
                    'substrate': 'Rein mineralisch, Gips',
                    'temperature': '20-28°C',
                    'germination_time': '3-8 Wochen',
                    'care_notes': 'Noch seltener als A. ritteri. Extrem langsam.',
                    'temperature_min': 10,
                    'temperature_max': 32,
                    'watering_summer': 'Minimal',
                    'watering_winter': 'Absolut trocken',
                    'light_requirements': 'Hell',
                    'special_care': 'Jüngere Entdeckung (1991)'
                },
                'Uncarina peltata': {
                    'substrate': 'Mineralisch mit organischem Anteil',
                    'temperature': '22-32°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Madagassische Caudex-Pflanze. Sommergrün.',
                    'temperature_min': 15,
                    'temperature_max': 38,
                    'watering_summer': 'Reichlich in der Wachstumszeit',
                    'watering_winter': 'Trocken (verliert Blätter)',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Gelbe Blüten, Caudex-Bildung'
                },
                'Uncarina decaryi': {
                    'substrate': 'Mineralisch mit organischem Anteil',
                    'temperature': '22-32°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Madagassische Caudex-Pflanze mit sukkulentem Stamm.',
                    'temperature_min': 15,
                    'temperature_max': 38,
                    'watering_summer': 'Reichlich',
                    'watering_winter': 'Trocken in Ruhezeit',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Bildet dicken Caudex'
                },
                'Uncarina roeoesliana': {
                    'substrate': 'Mineralisch mit organischem Anteil',
                    'temperature': '22-32°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Seltene Uncarina aus Madagaskar.',
                    'temperature_min': 15,
                    'temperature_max': 38,
                    'watering_summer': 'Reichlich',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Orange-rote Blüten'
                },
                'Stephania rotunda': {
                    'substrate': 'Humusreich, durchlässig',
                    'temperature': '20-28°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Asiatische Caudex-Pflanze. Kletterpflanze mit rundem Caudex.',
                    'temperature_min': 15,
                    'temperature_max': 32,
                    'watering_summer': 'Regelmäßig feucht',
                    'watering_winter': 'Trocken (zieht ein)',
                    'light_requirements': 'Hell, keine pralle Sonne',
                    'special_care': 'Benötigt Kletterhilfe'
                },
                'Stephania erecta': {
                    'substrate': 'Humusreich, durchlässig',
                    'temperature': '20-28°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Caudex-Pflanze aus Asien. Aufrechter Wuchs.',
                    'temperature_min': 15,
                    'temperature_max': 32,
                    'watering_summer': 'Regelmäßig',
                    'watering_winter': 'Trocken in Ruhezeit',
                    'light_requirements': 'Hell, indirekt',
                    'special_care': 'Kartoffelförmiger Caudex'
                },
                'Pyrenacantha malvifolia': {
                    'substrate': 'Humusreich, durchlässig',
                    'temperature': '20-30°C',
                    'germination_time': '3-6 Wochen',
                    'care_notes': 'Afrikanische Caudex-Pflanze mit Dornen am Stamm.',
                    'temperature_min': 15,
                    'temperature_max': 35,
                    'watering_summer': 'Regelmäßig',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Hell bis halbschattig',
                    'special_care': 'Stamm hat charakteristische Dornen'
                },
                'Moringa hildebrandtii': {
                    'substrate': 'Mineralisch, durchlässig',
                    'temperature': '25-35°C',
                    'germination_time': '1-2 Wochen',
                    'care_notes': 'Madagassischer Flaschenbaum. Pachycaul.',
                    'temperature_min': 18,
                    'temperature_max': 40,
                    'watering_summer': 'Mäßig',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Bildet dicken Flaschenstamm'
                },
                'Tephrocactus articulatus var. inermis': {
                    'substrate': 'Rein mineralisch',
                    'temperature': '20-30°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Dornenlose Form des Papierdornkaktus.',
                    'temperature_min': 5,
                    'temperature_max': 35,
                    'watering_summer': 'Sparsam',
                    'watering_winter': 'Absolut trocken',
                    'light_requirements': 'Volle Sonne',
                    'special_care': 'Glieder fallen leicht ab'
                },
                'Parodia penicillata': {
                    'substrate': 'Mineralisch',
                    'temperature': '18-28°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Kleine kugelförmige Art mit schönen Blüten.',
                    'temperature_min': 5,
                    'temperature_max': 32,
                    'watering_summer': 'Regelmäßig',
                    'watering_winter': 'Trocken und kühl',
                    'light_requirements': 'Hell bis vollsonnig',
                    'special_care': 'Rote bis orange Blüten'
                },
                'Turbinicarpus saueri ssp. knuthianus': {
                    'substrate': 'Rein mineralisch, kalkhaltig',
                    'temperature': '20-28°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Mexikanischer Zwergkaktus. Sehr klein bleibend.',
                    'temperature_min': 5,
                    'temperature_max': 32,
                    'watering_summer': 'Sehr sparsam',
                    'watering_winter': 'Absolut trocken',
                    'light_requirements': 'Hell',
                    'special_care': 'Bleibt winzig (2-3cm)'
                },
                'Mammillaria columbiana': {
                    'substrate': 'Mineralisch',
                    'temperature': '20-28°C',
                    'germination_time': '1-2 Wochen',
                    'care_notes': 'Gruppenbildende Art aus Kolumbien/Mexiko.',
                    'temperature_min': 10,
                    'temperature_max': 32,
                    'watering_summer': 'Mäßig',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Hell bis vollsonnig',
                    'special_care': 'Rosa Blüten im Kranz'
                },
                'Mammillaria backebergiana': {
                    'substrate': 'Mineralisch',
                    'temperature': '20-28°C',
                    'germination_time': '1-2 Wochen',
                    'care_notes': 'Kleine Art mit hakigen Mitteldornen.',
                    'temperature_min': 10,
                    'temperature_max': 32,
                    'watering_summer': 'Mäßig',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Hell',
                    'special_care': 'Purpurrote Blüten'
                },
                'Parodia nivosa': {
                    'substrate': 'Mineralisch',
                    'temperature': '18-28°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Schneeweiß bedornte Art.',
                    'temperature_min': 5,
                    'temperature_max': 32,
                    'watering_summer': 'Regelmäßig',
                    'watering_winter': 'Trocken und kühl',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Weiße Bedornung'
                },
                'Mammillaria glochidiata': {
                    'substrate': 'Mineralisch',
                    'temperature': '20-28°C',
                    'germination_time': '1-2 Wochen',
                    'care_notes': 'Kleine, sprossende Art.',
                    'temperature_min': 10,
                    'temperature_max': 32,
                    'watering_summer': 'Mäßig',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Hell',
                    'special_care': 'Bildet Gruppen'
                },
                'Cereus peruvianus': {
                    'substrate': 'Mineralisch mit etwas Humus',
                    'temperature': '20-30°C',
                    'germination_time': '1-3 Wochen',
                    'care_notes': 'Klassischer Säulenkaktus, schnellwüchsig.',
                    'temperature_min': 10,
                    'temperature_max': 35,
                    'watering_summer': 'Reichlich',
                    'watering_winter': 'Sparsam',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Nachtblüher, essbare Früchte'
                },
                'Oreocereus trollii': {
                    'substrate': 'Mineralisch',
                    'temperature': '15-25°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Alter Mann der Anden. Dicht weiß behaart.',
                    'temperature_min': 5,
                    'temperature_max': 28,
                    'watering_summer': 'Mäßig',
                    'watering_winter': 'Trocken und kühl',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Hochgebirgsart, verträgt Frost'
                },
                'Espostoa lanata': {
                    'substrate': 'Mineralisch',
                    'temperature': '18-28°C',
                    'germination_time': '2-4 Wochen',
                    'care_notes': 'Peruanischer Alter-Mann-Kaktus. Weiß wollig behaart.',
                    'temperature_min': 10,
                    'temperature_max': 32,
                    'watering_summer': 'Regelmäßig',
                    'watering_winter': 'Trocken',
                    'light_requirements': 'Vollsonne',
                    'special_care': 'Cephalium im Alter'
            }
        }
...
class PlantTracking(db.Model):
    """Tracking-Historie für Warenwirtschaft"""
    id = db.Column(db.Integer, primary_key=True)
    plant_id = db.Column(db.Integer, db.ForeignKey('plant.id'), nullable=False)
    species_id = db.Column(db.Integer, db.ForeignKey('species.id'), nullable=False)

    # Eindeutige Plant-ID (LOT-Nummer)
    unique_plant_id = db.Column(db.String(100), nullable=False)
    ...
    # Beziehungen
    plant = db.relationship('Plant', backref='tracking_history')
    species = db.relationship('Species', backref='tracking_records')

# 3. ERWEITERE dein Plant Model - Füge diese Felder zur Plant Klasse hinzu:
# (Falls die Felder schon existieren, überspringe sie)
"""
In deiner Plant Klasse, füge diese neuen Spalten hinzu:

    # NEUE FELDER für Warenwirtschaft
    plant_id = db.Column(db.String(100), unique=True)  # Format: TOPFNR_DDMMJJJJ
    from_sowing = db.Column(db.Boolean, default=False)
    sowing_id = db.Column(db.Integer, db.ForeignKey('sowing.id'))
    status = db.Column(db.String(50), default='active')  # active, sold, dead, gifted
    status_date = db.Column(db.Date)
    pot_size = db.Column(db.String(50))
"""

# 4. HILFSFUNKTION für Plant-ID Generierung
def generate_plant_id(pot_number, date=None):
    """Generiert eindeutige Plant-ID aus Topfnummer und Datum"""
    if date is None:
        date = datetime.now()
    elif isinstance(date, str):
        date = datetime.strptime(date, '%Y-%m-%d')
    date_str = date.strftime('%d%m%Y')
    return f"{pot_number}_{date_str}"

# 5. NEUE API ROUTEN - Füge diese zu deinen bestehenden Routen hinzu:

@app.route('/api/sowings/<int:sowing_id>/transfer-with-id', methods=['POST'])
def transfer_with_unique_id(sowing_id):
    """Überträgt gekeimte Pflanzen mit eindeutiger ID ins System"""
    sowing = Sowing.query.get_or_404(sowing_id)
    data = request.json

    # Keimung vermerken
    germination_date = datetime.strptime(data['germination_date'], '%Y-%m-%d').date()
    sowing.germinated = True
    sowing.germination_date = germination_date
    sowing.germinated_count = int(data.get('germinated_count', 1))

    # Eindeutige Plant-ID generieren
    unique_id = generate_plant_id(sowing.pot_number, germination_date)

    # Prüfen ob ID bereits existiert
    existing = Plant.query.filter_by(plant_id=unique_id).first()
    if existing:
        counter = 1
        while Plant.query.filter_by(plant_id=f"{unique_id}_{counter}").first():
            counter += 1
        unique_id = f"{unique_id}_{counter}"

    # Pflanze mit eindeutiger ID erstellen
    plant = Plant(
        species_id=sowing.species_id,
        purchase_date=germination_date,
        location=f"Topf {sowing.pot_number}",
        substrate='Mineralisch (Aussaat)',
        notes=f"Aus Aussaat vom {sowing.sowing_date.strftime('%d.%m.%Y')}. {sowing.germinated_count} Sämlinge.",
        plant_id=unique_id,  # Die eindeutige ID
        from_sowing=True,
        sowing_id=sowing_id,
        status='active',
        pot_size=data.get('pot_size', '5cm')
    )
    db.session.add(plant)
    db.session.flush()
    ...
    tracking = PlantTracking(
        plant_id=plant.id,
        species_id=sowing.species_id,
        unique_plant_id=unique_id,
        event_type='created_from_sowing',
        event_date=germination_date,
        old_value=f"Aussaat Topf {sowing.pot_number}",
        new_value=f"Plant-ID: {unique_id}",
        notes=f"{sowing.germinated_count} von {sowing.seed_count} gekeimt. Keimrate: {sowing.germination_rate}%"
    )
    ...
    diary = DiaryEntry(
        ...
        species_id=sowing.species_id,
        note=f"🌱 TRANSFER: {sowing.species.name} - Neue ID: {unique_id}",
    ...
    return jsonify({
        ...
        'plant_id': plant.id,
        'unique_plant_id': unique_id,
        'message': f'Transfer erfolgreich! Neue Plant-ID: {unique_id}'
    })

@app.route('/api/plants/<int:plant_id>/change-pot', methods=['POST'])
def change_pot_with_new_id(plant_id):
    """Topfwechsel mit neuer ID-Generierung"""
    plant = Plant.query.get_or_404(plant_id)
    data = request.json
    new_pot = data.get('new_pot')

    if not new_pot:
        return jsonify({'error': 'Neue Topfnummer fehlt'}), 400

    # Alte Werte speichern
    old_plant_id = plant.plant_id if plant.plant_id else f"Topf {plant.location}"
    old_location = plant.location

    # Neue Plant-ID generieren
    new_plant_id = generate_plant_id(new_pot)

    # Tracking erstellen
    tracking = PlantTracking(
        plant_id=plant.id,
        species_id=plant.species_id,
        unique_plant_id=new_plant_id,
        event_type='repotted',
        event_date=datetime.now().date(),
        old_value=f"{old_plant_id} - {old_location}",
        new_value=f"{new_plant_id} - Topf {new_pot}",
        notes=data.get('notes', '')
    )
    db.session.add(tracking)

    # Plant aktualisieren
    plant.plant_id = new_plant_id
    plant.location = f"Topf {new_pot}"
    plant.pot_size = data.get('pot_size', plant.pot_size)

    # Tagebucheintrag
    diary = DiaryEntry(
        date=datetime.now().date(),
        species_id=plant.species_id,
        note=f"🪴 Umgetopft: {old_location} → Topf {new_pot}. Neue ID: {new_plant_id}",
    ...
    return jsonify({
        ...
        'message': f'Umgetopft! Neue ID: {new_plant_id}'
    })

@app.route('/api/plants/<int:plant_id>/tracking-history', methods=['GET'])
def get_tracking_history(plant_id):
    """Komplette Historie einer Pflanze abrufen"""
    plant = Plant.query.get_or_404(plant_id)
    tracking = PlantTracking.query.filter_by(plant_id=plant_id).order_by(PlantTracking.event_date.desc()).all()

    history = {
        'plant_info': {
            'id': plant.id,
            'plant_id': plant.plant_id if plant.plant_id else 'Keine ID',
            'species': plant.species.name,
            'location': plant.location,
            'status': plant.status if plant.status else 'active',
            'from_sowing': plant.from_sowing if plant.from_sowing else False
        },
        'tracking_events': [{
            'date': t.event_date.isoformat(),
            'type': t.event_type,
            'plant_id': t.unique_plant_id,
    ...
    # Aussaat-Info hinzufügen wenn vorhanden
    if plant.from_sowing and plant.sowing_id:
        sowing = Sowing.query.get(plant.sowing_id)
        if sowing:
            history['source_sowing'] = {
                'sowing_date': sowing.sowing_date.isoformat(),
                'germination_date': sowing.germination_date.isoformat() if sowing.germination_date else None,
                'seed_count': sowing.seed_count,
                'germinated_count': sowing.germinated_count,
                'original_pot': sowing.pot_number
            }
...
def search_inventory():
    """Suche im Warenwirtschaftssystem"""
    ...
    if plant_id:
        query = query.filter(Plant.plant_id.like(f'%{plant_id}%'))

    if species_name:
        query = query.join(Species).filter(Species.name.like(f'%{species_name}%'))
    ...
    return jsonify([{
        'id': p.id,
        'plant_id': p.plant_id if p.plant_id else f"Topf {p.location}",
        'species': p.species.name,
        'location': p.location,
        'status': p.status if p.status else 'active',
        'purchase_date': p.purchase_date.isoformat(),
        'from_sowing': p.from_sowing if p.from_sowing else False
    } for p in plants])

@app.route('/api/inventory/export-with-ids', methods=['GET'])
def export_with_ids():
    """Export mit Plant-IDs als CSV"""
    plants = Plant.query.all()
    ...
    # Header
    writer.writerow([
        'Plant-ID', 'Art', 'Standort', 'Status',
        'Datum', 'Aus Aussaat', 'Tage in Sammlung', 'Notizen'
    ])

    # Daten
    for plant in plants:
        writer.writerow([
            plant.plant_id if plant.plant_id else 'Keine ID',
            plant.species.name,
            plant.location,
            plant.status if plant.status else 'active',
            plant.purchase_date.strftime('%d.%m.%Y'),
            'Ja' if (plant.from_sowing if plant.from_sowing else False) else 'Nein',
            plant.days_in_collection,
            plant.notes or ''
        ])

    output.seek(0)
    response = make_response(output.getvalue())
    response.headers['Content-Disposition'] = f'attachment; filename=warenwirtschaft_{datetime.now().strftime("%Y%m%d")}.csv'
    response.headers['Content-Type'] = 'text/csv; charset=utf-8-sig'

    return response

# 6. DATENBANK-MIGRATION - Füge diese Funktion hinzu und rufe sie beim Start auf:

def migrate_for_tracking():
    """Erweitert die Datenbank für Warenwirtschaft"""
    with app.app_context():
        inspector = inspect(db.engine)
        existing_tables = inspector.get_table_names()

        # Neue Tracking-Tabelle erstellen
        if 'plant_tracking' not in existing_tables:
            db.create_all()
            print("✅ PlantTracking-Tabelle erstellt")

        # Plant-Tabelle erweitern
        if 'plant' in existing_tables:
            ...
            with db.engine.connect() as conn:
                ...
                if 'plant_id' not in columns:
                    conn.execute('ALTER TABLE plant ADD COLUMN plant_id VARCHAR(100)')
                    conn.commit()
                    print("✅ plant_id Spalte hinzugefügt")

                if 'from_sowing' not in columns:
                    conn.execute('ALTER TABLE plant ADD COLUMN from_sowing BOOLEAN DEFAULT FALSE')
                    conn.commit()
                    print("✅ from_sowing Spalte hinzugefügt")

                if 'sowing_id' not in columns:
                    conn.execute('ALTER TABLE plant ADD COLUMN sowing_id INTEGER')
                    conn.commit()
                    print("✅ sowing_id Spalte hinzugefügt")

                if 'status' not in columns:
                    conn.execute("ALTER TABLE plant ADD COLUMN status VARCHAR(50) DEFAULT 'active'")
                    conn.commit()
                    print("✅ status Spalte hinzugefügt")

                if 'status_date' not in columns:
                    conn.execute('ALTER TABLE plant ADD COLUMN status_date DATE')
                    conn.commit()
                    print("✅ status_date Spalte hinzugefügt")

                if 'pot_size' not in columns:
                    conn.execute('ALTER TABLE plant ADD COLUMN pot_size VARCHAR(50)')
                    conn.commit()
                    print("✅ pot_size Spalte hinzugefügt")

        # IDs für bestehende Pflanzen generieren
        plants = Plant.query.filter(Plant.plant_id == None).all()
        for plant in plants:
            if not plant.plant_id:
                # Versuche Topfnummer aus location zu extrahieren
                if plant.location and 'Topf' in plant.location:
                    pot = plant.location.replace('Topf ', '').strip()
                else:
                    pot = f"P{plant.id}"  # Fallback

                plant.plant_id = generate_plant_id(pot, plant.purchase_date)

        if plants:
            db.session.commit()
            print(f"✅ {len(plants)} Plant-IDs generiert")
# ==================== APP STARTEN ====================
...
# Erweiterte app.py - Fügen Sie diese neuen Routen zu Ihrer bestehenden app.py hinzu
    # Migration für Warenwirtschaft
    migrate_for_tracking()
# ==================== NEUE MODELLE ====================
